...
Version  : 7.20.2
Release  : 39
URL      : https://github.com/BOINC/boinc/archive/client_release/7.20/7.20.2/boinc-7.20.2.tar.gz
Source0  : https://github.com/BOINC/boinc/archive/client_release/7.20/7.20.2/boinc-7.20.2.tar.gz
...
%prep
%setup -q -n boinc-client_release-7.20-7.20.2
cd %{_builddir}/boinc-client_release-7.20-7.20.2
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663084599
...
/usr/lib64/libboinc_api.so.7.20.2
/usr/lib64/libboinc_opencl.so.7
/usr/lib64/libboinc_opencl.so.7.20.2
