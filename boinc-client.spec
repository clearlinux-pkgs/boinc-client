...
%package staticdev
Summary: staticdev components for the boinc-client package.
Group: Default
Requires: boinc-client-dev = %{version}-%{release}

%description staticdev
staticdev components for the boinc-client package.


%prep
%setup -q -n boinc-client_release-8.0-8.0.2
cd %{_builddir}/boinc-client_release-8.0-8.0.2
%patch -P 1 -p1
pushd ..
cp -a boinc-client_release-8.0-8.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720534935
...
export GOAMD64=v2
%reconfigure  DOCBOOK2X_MAN='/usr/bin/db2x_xsltproc -s man $< -o $(patsubst %.xml,%.mxml,$<); db2x_manxml $(patsubst %.xml,%.mxml,$<); echo' \
...
cp %{_builddir}/boinc-client_release-8.0-%{version}/COPYING.LESSER %{buildroot}/usr/share/package-licenses/boinc-client/e203d4ef09d404fa5c03cf6590e44231665be689 || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/COPYRIGHT %{buildroot}/usr/share/package-licenses/boinc-client/62512a302b5fc9d3f15ad8ae0775aecbf08f7b4d || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/api/ttf/liberation-fonts-ttf-2.00.0/LICENSE %{buildroot}/usr/share/package-licenses/boinc-client/0898cb73de9283d38e6f4cef45ce79efbfafb0b2 || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/all/libraries/ckeditor/samples/toolbarconfigurator/lib/codemirror/LICENSE %{buildroot}/usr/share/package-licenses/boinc-client/4dbb477bdccb1d3b4fc6e73b899d1a287b199f98 || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/all/libraries/phpmailer/LICENSE %{buildroot}/usr/share/package-licenses/boinc-client/d156a1bf8185f65cd8b9d3c06fd011428d0214f5 || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/all/libraries/tinymce/jscripts/tiny_mce/license.txt %{buildroot}/usr/share/package-licenses/boinc-client/05ce47af4fb5f4f4a65b8f7f0a67e9935ff0ae70 || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/all/themes/zen/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/919ebd0505421520215536126e8dee39fc1ef529 || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/bbcode/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/919ebd0505421520215536126e8dee39fc1ef529 || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/cck/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/ckeditor/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/content_profile/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/919ebd0505421520215536126e8dee39fc1ef529 || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/context/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/ctools/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/elysia_cron/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/facetapi/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/features/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/filefield/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/flag/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/forum_access/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/htmlpurifier/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/919ebd0505421520215536126e8dee39fc1ef529 || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/i18nviews/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/919ebd0505421520215536126e8dee39fc1ef529 || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/jump/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/panels/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/privatemsg/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/919ebd0505421520215536126e8dee39fc1ef529 || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/tableofcontents/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/views/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/contrib/wysiwyg/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/919ebd0505421520215536126e8dee39fc1ef529 || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/drupal/sites/default/boinc/modules/node_comment_block/LICENSE.txt %{buildroot}/usr/share/package-licenses/boinc-client/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/html/inc/random_compat/LICENSE %{buildroot}/usr/share/package-licenses/boinc-client/89ea22f8eed658271c62456bacc37b24a77173a4 || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/mac_installer/License.rtf %{buildroot}/usr/share/package-licenses/boinc-client/857cfa94afe9fb9b3e73cfb170c1d94155aaf94a || :
cp %{_builddir}/boinc-client_release-8.0-%{version}/samples/wrappture/license.terms %{buildroot}/usr/share/package-licenses/boinc-client/3fad046d74e3ba1138e908e168a325e6a14b8ac0 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libboinc_api.so.8.0.2
/V3/usr/lib64/libboinc_opencl.so.8.0.2
/usr/lib64/libboinc_api.so.8
/usr/lib64/libboinc_api.so.8.0.2
/usr/lib64/libboinc_opencl.so.8
/usr/lib64/libboinc_opencl.so.8.0.2
