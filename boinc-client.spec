...
%patch -P 1 -p1
pushd ..
cp -a boinc-client_release-7.24-7.24.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707073783
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libboinc_api.so.7.24.1
/V3/usr/lib64/libboinc_opencl.so.7.24.1
