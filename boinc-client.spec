...
Version  : 7.20.4
Release  : 41
URL      : https://github.com/BOINC/boinc/archive/client_release/7.20/7.20.4/boinc-7.20.4.tar.gz
Source0  : https://github.com/BOINC/boinc/archive/client_release/7.20/7.20.4/boinc-7.20.4.tar.gz
...
%prep
%setup -q -n boinc-client_release-7.20-7.20.4
cd %{_builddir}/boinc-client_release-7.20-7.20.4
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668451745
...
/usr/lib64/libboinc_api.so.7.20.4
/usr/lib64/libboinc_opencl.so.7
/usr/lib64/libboinc_opencl.so.7.20.4
